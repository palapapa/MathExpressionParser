...
public class MathOperatorTests
{
    ...
    public void GetInvalidOperators_ArgumentNull_ArgumentNullException()
    {
        ...
        (
            () =>
            {
                MathOperator.GetInvalidOperators(null);
            },
    ...
    [TestMethod]
    public void GetInvalidOperators_NullInArgument_ArgumentException()
    {
        List<MathOperator> argument = new() { null };
        TestUtilities.AssertException<ArgumentException>
        (
            () =>
            {
                MathOperator.GetInvalidOperators(argument);
            },
            $"It should be thrown when the argument contains null {nameof(MathOperator)}s."
        );
    }
